...
def retrievedata(mydb,cur):
	...
	#	result = cur.fetchall()
	#	return result
	#	print("Enter a character to search from the table<br><br>")

def displaytest(result):
	print("<div id = 'bottom' style='text-align:center; font-fammily: Eras Bold ITC; font-size:medium;'>")
	print("<table border = '1' align='center'>")
	print("<tr align='center'>")
	print("<th bgcolor='#000f2b' align='center'>STOVEPIPE</th>")
	print("<th bgcolor='#000f2b' align='center'>DATACENTER</th>")
	print("<th bgcolor='#000f2b' align='center'>VIRTUAL SERVER NAME</th>")
	print("<th bgcolor='#000f2b' align='center'>FQDN</th>")
	print("<th bgcolor='#000f2b' align='center'>IP ADDRESS</th>")
	print("<th bgcolor='#000f2b' align='center'>SERVICE PORT</th>")
	print("<th bgcolor='#000f2b' align='center'>SECURITY POLICY</th>")
	print("<th bgcolor='#000f2b' align='center'>DEVICE NAME</th>")
	print("</tr>")
	for x in result or []:
		print("<tr align='center'>")
...
#		print("<body style = 'background-color:#FFFFFF'>")
		...
		print("<h1 style='color=white'; font='Eras Bold ITC'> WAF Search </h1>")
		print("<p style='color=white'; font='Eras Bold ITC'> Enter a word to search for example: UTC or fannie or 10.136 etc. </p>")
